    ...
    <div class="modal-detail">
      <div class="modal-detail-header">
        ...
        <ul class="download-list">
          <li><a href="#" aria-disabled="true"><span>产品样本 PDF</span><span>待上传</span></a></li>
          <li><a href="#" aria-disabled="true"><span>安装说明书</span><span>待上传</span></a></li>
          <li><a href="#" aria-disabled="true"><span>CAD/设计资料</span><span>待上传</span></a></li>
        </ul>
      </div>
    </div>
  `;
...
(function initSelxTool() {
  ...
  addRoom({ type: "客厅", area: 30, height: 2.7, ach: 1.0, people: 2, pplRate: 30 });
  addRoom({ type: "主卧", area: 18, height: 2.7, ach: 1.0, people: 2, pplRate: 30 });
  addRoom({ type: "次卧", area: 12, height: 2.7, ach: 1.0, people: 1, pplRate: 30 });
...
function initAcSelector() {
  ...
  addRoom('客厅', '', 40, 220, defaultIndoorSeries, 1, 1);
  addRoom('主卧', '', 20, 220, defaultIndoorSeries, 1, 1);
  addRoom('次卧', '', 15, 220, defaultIndoorSeries, 1, 1);
  addRoom('书房', '', 12, 220, defaultIndoorSeries, 1, 1);
...
function initSixFresh() {
  ...
  addRoom({ name: '影音室', area: 25, height: 2.7, ach: 1.0, floor: 'B2', sysid: 1 });
  addRoom({ name: '储藏室', area: 15, height: 2.7, ach: 1.0, floor: 'B1', sysid: 1 });
  addRoom({ name: '客厅', area: 35, height: 2.7, ach: 1.0, floor: '1', sysid: 1 });
  addRoom({ name: '餐厅', area: 20, height: 2.7, ach: 1.0, floor: '1', sysid: 1 });
  addRoom({ name: '主卧', area: 25, height: 2.7, ach: 1.0, floor: '2', sysid: 1 });
  addRoom({ name: '次卧', area: 18, height: 2.7, ach: 1.0, floor: '2', sysid: 1 });
  addRoom({ name: '书房', area: 15, height: 2.7, ach: 1.0, floor: '2', sysid: 1 });
  addRoom({ name: '儿童房', area: 18, height: 2.7, ach: 1.0, floor: '3', sysid: 1 });
  addRoom({ name: '客房', area: 16, height: 2.7, ach: 1.0, floor: '3', sysid: 1 });
  addRoom({ name: '起居室', area: 20, height: 2.7, ach: 1.0, floor: '3', sysid: 1 });
  ...
  function autoSplitByFloor() {
    ...
    const floorToSys = {};
    floorOrder.forEach((floor, idx) => {
      floorToSys[floor] = idx + 1;
    });
